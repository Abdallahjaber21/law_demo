   ...
   ********************/
        ...
        getNumber: function(format) {
            if (window.intlTelInputUtils) {
                ...
                return this.isValidNumber() ? intlTelInputUtils.formatNumber(this._getFullNumber(), this.selectedCountryData.iso2, format) : null;
            }
            return "";
        },
        ...
        getNumberType: function() {
            if (window.intlTelInputUtils) {
                return this.intlTelInputUtils.getNumberType(this._getFullNumber(), this.selectedCountryData.iso2);
            }
            return -99;
        },
