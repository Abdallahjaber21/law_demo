...
<div class="country-index">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            ?> <?php if (P::c(P::CONFIGURATIONS_COUNTRY_PAGE_NEW)) {
                ...
                'columns' => [
                    [
                        ...
                        'value' => function ($model) {
                            $url = \yii\helpers\Url::to(['country/view', 'id' => $model->id]);
                    ...
                    [
                        ...
                        'permissions' => [
                            'view' => P::CONFIGURATIONS_COUNTRY_PAGE_VIEW,
                            'update' => P::CONFIGURATIONS_COUNTRY_PAGE_UPDATE,
                            'enable' =>  P::CONFIGURATIONS_COUNTRY_PAGE_UPDATE,
                            'disable' =>  P::CONFIGURATIONS_COUNTRY_PAGE_UPDATE,
                            'delete' => false
                        ],
                    ],
                ],
