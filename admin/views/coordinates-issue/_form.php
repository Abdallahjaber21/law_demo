...
<div class="coordinates-issue-form">
...
<div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <?= $form->field($model, 'old_latitude')->textInput(['maxlength' => true]) ?>
                        </div>
                        <div class="col-sm-6">
                            <?= $form->field($model, 'old_longitude')->textInput(['maxlength' => true]) ?>
                        </div>
                        <div class="col-sm-6">
                            <?= $form->field($model, 'new_latitude')->textInput(['maxlength' => true]) ?>
                        </div>
                        <div class="col-sm-6">
                            <?= $form->field($model, 'new_longitude')->textInput(['maxlength' => true]) ?>
                        </div>
                        <div class="col-sm-6">
