...
<div class="location-index">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="button-container <?php echo (P::c(P::MANAGEMENT_LOCATION_PAGE_NEW)) ? '' : 'buttonpostion'; ?>">
                ...
                ?>
                <?php if ((P::c(P::MANAGEMENT_LOCATION_PAGE_EXPORT))) { ?>
                    <div class="form-group">
                        <?= Html::beginForm(['location/index'] + Yii::$app->request->queryParams, 'GET', ['class' => 'form-inline', 'id' => 'date-range-form']) ?>
                        <?= Html::submitButton(
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute' => 'clone',
                        'label' => 'Clone',
                        'headerOptions' => ['style' => 'width:75px', 'class' => 'minus-header', 'data-attribute' => 'clone'],
                        'visible' => !in_array('clone', $hiddenAttributes),
                    ...
                    [
                            ...
                            'delete' => function ($url, $model, $key) {
                                ...
                                if ($model->status == Location::STATUS_DELETED) {
                                    if (P::c(P::MANAGEMENT_LOCATION_PAGE_DELETE)) {
                                        return Html::beginForm(['/dynamic/undelete', 'parentClass' => 'common\models\Sector', 'parentId' => $model->sector_id, 'currentClass' => $parentClass, 'currentId' => $parentId, 'childClass' => $childClass, 'paramsAttribute' => $paramsAttribute], 'post') .
                        ...
                        'permissions' => [
                            ...
                            'audit' => P::MANAGEMENT_LOCATION_PAGE_AUDIT,
                        ],
                    ],
                    [
                        ...
                        'value' => function ($model) {
                            $classname = !empty($model->locationEquipments) ? 'btn btn-xs btn-success' : 'btn btn-xs btn-danger';
                            return Html::a('Equipments', Url::to(['location-equipments/index', 'location_id' => $model->id]), ['class' => $classname]);
                        },
                        'format' => 'raw'
                    ],
                ],
