    ...
    <div data-repeater-list="outer-list">
        <div data-repeater-item class="well well-sm">
            ...
            <div class="input-group">
                ...
                <?= Html::dropDownList("equipment_type", $model->equipment_type, (new MaintenanceTaskGroup())->equipment_type_list, [
                    'class' => 'form-control',
                    'placeholder' => 'Equipment Type']) ?>
                <span class="input-group-addon"></span>
                <?= Html::textInput("group_code", $model->code, [
                    'class' => 'form-control',
                    'placeholder' => 'Group Code']) ?>
                <span class="input-group-addon"></span>

                <?= Html::textInput("group_name", $model->name, [
                    'class' => 'form-control',
                    'placeholder' => 'Group Name']) ?>
                <span class="input-group-addon"></span>

                <?= Html::textInput("group_order", $model->group_order, [
                    'class' => 'form-control',
            ...
            <div class="inner-repeater">
                ...
                <table data-repeater-list="inner-list"
                    ...
                    <tbody>
                    <?php foreach ($model->maintenanceTasks as $index => $maintenanceTask) { ?>
                        ...
                        <tr data-repeater-item>
                            ...
                            <td>
                                <?= Html::hiddenInput("task_id", $maintenanceTask->id) ?>
                                <?= Html::textInput("task_code", $maintenanceTask->code, [
                                    'class' => 'form-control',
                                    'required' => '',
                                    'placeholder' => 'Task Code']) ?>
                            </td>
                            <td>
                                <?= Html::textInput("task_name",  $maintenanceTask->name, [
                                    'class' => 'form-control',
                                    'required' => '',
                            ...
                            <?php for ($i = 1; $i <= 12; $i++) { ?>
                                ...
                                <?php $varB = "m_{$i}_b" ?>
                                <td>
                                    <?= Html::checkbox("m_{$i}_a", $maintenanceTask->{$varA}) ?>
                                </td>
                                <td>
                                    <?= Html::checkbox("m_{$i}_b", $maintenanceTask->{$varB}) ?>
                                </td>
                            <?php } ?>
                            <td>
