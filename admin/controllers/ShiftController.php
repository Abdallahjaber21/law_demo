...
class ShiftController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => P::c(P::CONFIGURATIONS_SHIFT_PAGE_VIEW),
                        'actions' => ['index', 'view'],
                        'roles' => ['@'],
                    ],
                    [
                        'allow' => P::c(P::CONFIGURATIONS_SHIFT_PAGE_UPDATE),
                        'actions' => ['update'],
                        'roles' => ['@'],
                    ],
                    // [
                    ...
                    // ],
                    [
                        'allow' => P::c(P::CONFIGURATIONS_SHIFT_PAGE_NEW),
                        'actions' => ['create'],
                        'roles' => ['@'],
                    ],
                ],
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->getSession()->addFlash("success", "Shift: " . $model->name . " is created successfully");
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->getSession()->addFlash("warning", "Shift: " . $model->name . " is updated successfully");
            return $this->redirect(['index']);
        } else {
    ...
    public function actionDelete($id)
    {
        ...
        Yii::$app->session->addFlash("danger", "Shift " . $name . " is deleted");
    ...
    protected function findModel($id)
    {
        if (($model = Shift::findOne($id)) !== null) {
            //        if (($model = Shift::find()->multilingual()->where(['id'=>$id])->one()) !== null) {
            return $model;
        } else {
