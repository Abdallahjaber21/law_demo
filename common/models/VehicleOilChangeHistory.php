...
/**
 * This is the model class for table "vehicle_oil_change_history".
 *
 * @property integer $id
 * @property integer $repair_request_id
 * @property integer $asset_id
 * @property integer $oil_id
 * @property double $meter_value
 ...
 * @property EngineOilTypes $oil
 * @property RepairRequest $repairRequest
 *
 * @property string $status_label
 * @property label $status_list
 */
class VehicleOilChangeHistory extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['repair_request_id', 'asset_id', 'oil_id', 'status', 'created_by', 'updated_by'], 'integer'],
            [['meter_value', 'next_oil_change'], 'number'],
            ...
            [['oil_id'], 'exist', 'skipOnError' => true, 'targetClass' => EngineOilTypes::className(), 'targetAttribute' => ['oil_id' => 'id']],
...
// }
    ...
    */
    ...
    {
        return $this->hasOne(EngineOilTypes::className(), ['id' => 'oil_id']);
    }
