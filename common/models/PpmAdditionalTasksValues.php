...
/**
 * This is the model class for table "ppm_additional_tasks_values".
 *
 * @property integer $id
 * @property integer $ppm_service_id
 * @property integer $asset_id
 * @property integer $additional_task_id
 ...
 *
 * @property PpmAdditionalTasks $additionalTask
 ...
 */
class PpmAdditionalTasksValues extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ppm_service_id', 'asset_id', 'additional_task_id', 'status', 'created_by', 'updated_by'], 'integer'],
            [['created_at', 'updated_at'], 'safe'],
            [['value'], 'string'],
            [['additional_task_id'], 'exist', 'skipOnError' => true, 'targetClass' => PpmAdditionalTasks::className(), 'targetAttribute' => ['additional_task_id' => 'id']],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'asset_id' => 'Asset ID',
            'additional_task_id' => 'Additional Task ID',
            'value' => 'Value',
            'status' => 'Status',
...
*/
     ...
     */
    public function getAdditionalTask()
    {
        return $this->hasOne(PpmAdditionalTasks::className(), ['id' => 'additional_task_id']);
    }
