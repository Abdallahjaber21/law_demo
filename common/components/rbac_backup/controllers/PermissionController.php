    ...
    public function behaviors() {
        return [
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => Yii::$app->getUser()->can("rbac-view-permissions"),
                        'actions' => ['index'],
                        'roles' => ['@'],
                    ],
                    [
                        'allow' => Yii::$app->getUser()->can("rbac-edit-permissions"),
                        'actions' => ['update'],
                        'roles' => ['@'],
                    ],
                    [
                        'allow' => Yii::$app->getUser()->can("rbac-delete-permissions"),
                        'actions' => ['delete'],
                        'roles' => ['@'],
                    ],
                    [
                        'allow' => Yii::$app->getUser()->can("rbac-create-permissions"),
                        'actions' => ['create'],
                        'roles' => ['@'],
                    ],
                ],
